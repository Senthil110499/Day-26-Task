let roomData = [
  ...
  },
  {
    ...
    room_name: "Luxury",
    room_status: "available",
    amenities: "TV, A/C, WiFi, Swimming pool",
    seats: 4,
    price_per_hour: 4500,
  },
  {
...
// Function to fetch all rooms booking data

export const getHallDetail = (req,res) => {
    res.status(200).json({message: "All Room data fetched Successfully!",data:roomData})
}
...
export const BookRoom = (req, res) => {
  ...
  if (!room) {
    ...
    if (BookingRoomsdate.length > 0) {
      ...
      return res.status(200).json({message: "Room is Booked Successfully",
...
export const BookedRoomData = (req, res) => {
  ...
  res.status(200).json({message: "Successfully Fetched All Rooms Data",BookingRoom,});
};
...
export const AllCustomersBookedData = (req, res) => {
  ...
  res.status(200).json({message: "Successfully Fetched All Customers with Booked Room Details",customerdata,});
};
...
export const CustomerBookingDetails = (req, res) => {
  ...
  res.status(200).json({message: "Successfully Fetched Customer Booked Count Details",customerData,});
};